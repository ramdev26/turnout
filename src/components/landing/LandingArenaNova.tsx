    ...
    <header className="landing-arena-header">
      <div className="landing-arena-header-inner">
        <div className="landing-arena-header-brand">
          ...
          <span className="landing-arena-header-label landing-type-h2" title={brand.name}>
            {fullName}
          </span>
        </div>
      </div>
...
function ArenaNovaEventIntro({ event }: { event: Event }) {
  ...
  return (
    <div className="landing-arena-intro">
      <p className="landing-arena-organizer landing-type-h2">{brand.name.toUpperCase()}</p>
      <h1 className="landing-arena-title landing-type-h1">{title}</h1>
      {lead ? <p className="landing-arena-lead landing-type-p">{lead}</p> : null}
    </div>
  );
}
  ...
  return (
    <section className="landing-arena-about" id="landing-about">
      ...
      <div className="landing-arena-about-card">
        <p
          className={`landing-arena-about-text landing-type-p${canExpand && !expanded ? ' is-clamped' : ''}`}
        >
          {desc}
        </p>
        {canExpand ? (
    ...
    <div className="landing-arena-event-card">
      <div className="landing-arena-date-row">
        <div>
          ...
          <p className="landing-arena-date-sub landing-type-h3">
      ...
      <div className="landing-arena-location-row">
        <div className="landing-arena-location-text landing-type-h3">
            ...
            <div className="landing-arena-countdown-grid" aria-live="polite">
              {[
                ...
                <div key={u.lbl} className="landing-arena-countdown-unit">
                  <span className="num landing-type-h2">{pad2(u.val)}</span>
    ...
    <div className={`landing-arena-ticket${popular ? ' is-popular' : ''}`}>
      ...
      <div className="landing-arena-ticket-top">
        ...
        <div className="landing-arena-ticket-body">
          <h3 className="landing-arena-ticket-name landing-type-h2">{ticket.name}</h3>
          <p className="landing-arena-ticket-desc landing-type-p">{desc}</p>
          <p className="landing-arena-ticket-price landing-type-h3">
      ...
      <div className="landing-arena-ticket-bar">
        ...
        <button type="button" className="landing-arena-add-btn landing-type-btn" disabled={soldOut || qty >= remaining} onClick={addOne}>
          Add
        </button>
      </div>
    </div>
...
function ArenaNovaSummary({
  ...
  return (
    <div className="landing-arena-summary">
      ...
      <button type="button" className="landing-arena-checkout-btn landing-type-btn" onClick={onCheckout} disabled={isPurchasing}>
