...
export const AdminShell: React.FC<{ title: string; subtitle?: string; children: React.ReactNode }> = ({ title, subtitle, children }) => {
  const location = useLocation();
  return (
    <div className="grid gap-6 lg:grid-cols-[240px_minmax(0,1fr)]">
      <aside className="rounded-2xl border border-neutral-200 bg-white p-3 shadow-sm">
        <div className="px-3 pb-3 pt-1 text-sm font-semibold text-neutral-900">Platform Control</div>
