...
function buildLiveUi(design: LandingDesignValue, baseUi: CreateThemeUI): CreateThemeUI {
  ...
  return {
    ...
    accentHover: 'color-mix(in srgb, var(--landing-accent-readable, var(--primary)) 84%, black)',
    accentSoft: 'color-mix(in srgb, var(--landing-accent-readable, var(--primary)) 18%, transparent)',
