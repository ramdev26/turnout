...
export const AttendeeSignup: React.FC = () => {
  ...
  const onSubmit = async (values: FormValues) => {
    ...
    try {
      const res = parseAuthPayload(
        await api.post<unknown>('/api/auth/register-attendee', values)
      );
  ...
  return (
    <AuthFlowLayout title="Create attendee account" subtitle="Save your details and check in faster for every event.">
