  ...
  const loadAll = async () => {
    ...
    try {
      ...
      setDesign({
        ...
        h2Color: landing.h2Color,
        h3Color: landing.h3Color,
        buttonTextColor: landing.buttonTextColor,
        iconColor: landing.iconColor,
        linkColor: landing.linkColor,
        bannerOutlineColor: landing.bannerOutlineColor,
        bannerOutlineWidth: landing.bannerOutlineWidth,
        h1FontFamily: landing.h1FontFamily ? resolveLandingFontKey(landing.h1FontFamily) : undefined,
        h2FontFamily: landing.h2FontFamily ? resolveLandingFontKey(landing.h2FontFamily) : undefined,
        h3FontFamily: landing.h3FontFamily ? resolveLandingFontKey(landing.h3FontFamily) : undefined,
        bodyFontFamily: landing.bodyFontFamily ? resolveLandingFontKey(landing.bodyFontFamily) : undefined,
        buttonFontFamily: landing.buttonFontFamily ? resolveLandingFontKey(landing.buttonFontFamily) : undefined,
        ...
        h1FontSizeMobile: landing.h1FontSizeMobile,
        h2FontSizeMobile: landing.h2FontSizeMobile,
        h3FontSize: landing.h3FontSize,
        h3FontSizeMobile: landing.h3FontSizeMobile,
        bodyFontSizeMobile: landing.bodyFontSizeMobile,
        buttonFontSize: landing.buttonFontSize,
        buttonFontSizeMobile: landing.buttonFontSizeMobile,
        ...
        h3Bold: landing.h3Bold,
        h3Italic: landing.h3Italic,
        h3Underline: landing.h3Underline,
        buttonTextBold: landing.buttonTextBold,
        buttonTextItalic: landing.buttonTextItalic,
        buttonTextUnderline: landing.buttonTextUnderline,
        buttonRadius: landing.buttonRadius,
        buttonOutlineWidth: landing.buttonOutlineWidth,
        buttonOutlineColor: landing.buttonOutlineColor,
        buttonShadow: landing.buttonShadow,
      });
  ...
  const saveBranding = async () => {
    ...
    try {
      ...
      const res = await api.post<{ event: Event }>(`/api/events/${eventId}/branding`, {
        ...
        h2Color: design.h2Color || null,
        h3Color: design.h3Color || null,
        buttonTextColor: design.buttonTextColor || null,
        iconColor: design.iconColor || null,
        linkColor: design.linkColor || null,
        bannerOutlineColor: design.bannerOutlineColor || null,
        bannerOutlineWidth: design.bannerOutlineWidth ?? null,
        h1FontFamily: design.h1FontFamily || null,
        h2FontFamily: design.h2FontFamily || null,
        h3FontFamily: design.h3FontFamily || null,
        bodyFontFamily: design.bodyFontFamily || null,
        buttonFontFamily: design.buttonFontFamily || null,
        ...
        h1FontSizeMobile: design.h1FontSizeMobile ?? null,
        h2FontSizeMobile: design.h2FontSizeMobile ?? null,
        h3FontSize: design.h3FontSize ?? null,
        h3FontSizeMobile: design.h3FontSizeMobile ?? null,
        bodyFontSizeMobile: design.bodyFontSizeMobile ?? null,
        buttonFontSize: design.buttonFontSize ?? null,
        buttonFontSizeMobile: design.buttonFontSizeMobile ?? null,
        ...
        h3Bold: design.h3Bold ?? null,
        h3Italic: design.h3Italic ?? null,
        h3Underline: design.h3Underline ?? null,
        buttonTextBold: design.buttonTextBold ?? null,
        buttonTextItalic: design.buttonTextItalic ?? null,
        buttonTextUnderline: design.buttonTextUnderline ?? null,
        buttonRadius: design.buttonRadius ?? null,
        buttonOutlineWidth: design.buttonOutlineWidth ?? null,
        buttonOutlineColor: design.buttonOutlineColor || null,
        buttonShadow: design.buttonShadow || null,
        templateId: design.templateId,
      ...
      setDesign((prev) => ({
        ...
        h2Color: res.event.customization?.h2Color,
        h3Color: res.event.customization?.h3Color,
        buttonTextColor: res.event.customization?.buttonTextColor,
        iconColor: res.event.customization?.iconColor,
        linkColor: res.event.customization?.linkColor,
        bannerOutlineColor: res.event.customization?.bannerOutlineColor,
        bannerOutlineWidth: res.event.customization?.bannerOutlineWidth,
        h1FontFamily: res.event.customization?.h1FontFamily
          ? resolveLandingFontKey(res.event.customization.h1FontFamily)
          : undefined,
        h2FontFamily: res.event.customization?.h2FontFamily
          ? resolveLandingFontKey(res.event.customization.h2FontFamily)
          : undefined,
        h3FontFamily: res.event.customization?.h3FontFamily
          ? resolveLandingFontKey(res.event.customization.h3FontFamily)
          : undefined,
        bodyFontFamily: res.event.customization?.bodyFontFamily
          ? resolveLandingFontKey(res.event.customization.bodyFontFamily)
          : undefined,
        buttonFontFamily: res.event.customization?.buttonFontFamily
          ? resolveLandingFontKey(res.event.customization.buttonFontFamily)
          : undefined,
        ...
        h1FontSizeMobile: res.event.customization?.h1FontSizeMobile,
        h2FontSizeMobile: res.event.customization?.h2FontSizeMobile,
        h3FontSize: res.event.customization?.h3FontSize,
        h3FontSizeMobile: res.event.customization?.h3FontSizeMobile,
        bodyFontSizeMobile: res.event.customization?.bodyFontSizeMobile,
        buttonFontSize: res.event.customization?.buttonFontSize,
        buttonFontSizeMobile: res.event.customization?.buttonFontSizeMobile,
        ...
        h3Bold: res.event.customization?.h3Bold,
        h3Italic: res.event.customization?.h3Italic,
        h3Underline: res.event.customization?.h3Underline,
        buttonTextBold: res.event.customization?.buttonTextBold,
        buttonTextItalic: res.event.customization?.buttonTextItalic,
        buttonTextUnderline: res.event.customization?.buttonTextUnderline,
        buttonRadius: res.event.customization?.buttonRadius,
        buttonOutlineWidth: res.event.customization?.buttonOutlineWidth,
        buttonOutlineColor: res.event.customization?.buttonOutlineColor,
        buttonShadow: res.event.customization?.buttonShadow,
      }));
